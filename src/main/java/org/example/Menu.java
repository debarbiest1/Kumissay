...
public class Menu {
    public Menu(Scanner scanner, ElectronicsShop shop){
        while(true){
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    scanner.nextLine();
                    Client clientToGiveProduct = Finder.findClientById(clientID);
                    Product productToGive = Finder.findProductById(productID);
